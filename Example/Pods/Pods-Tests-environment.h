...
#define COCOAPODS_POD_AVAILABLE_HPPageViewController
#define COCOAPODS_VERSION_MAJOR_HPPageViewController 0
#define COCOAPODS_VERSION_MINOR_HPPageViewController 1
#define COCOAPODS_VERSION_PATCH_HPPageViewController 0
